...
import {
  Results,
  RockPaperScissorsOptions as RockPaperScissorsOptions,
} from "./Enum";

export const D = (n: Decimal.Value) => new Decimal(n);

export function doRockPaperScissors(
  playerChoice: RockPaperScissorsOptions,
  ...
  switch (playerChoice) {
    case RockPaperScissorsOptions.ROCK:
      return computerChoice === RockPaperScissorsOptions.SCISSORS
        ? Results.WIN
        : Results.LOSE;
    case RockPaperScissorsOptions.PAPER:
      return computerChoice === RockPaperScissorsOptions.ROCK
        ? Results.WIN
        : Results.LOSE;
    case RockPaperScissorsOptions.SCISSORS:
      return computerChoice === RockPaperScissorsOptions.PAPER
        ? Results.WIN
        : Results.LOSE;
  }
}
